...
# Flags /* too old modem version
BOARD_GLOBAL_CFLAGS   += -DUSE_RIL_VERSION_10
BOARD_GLOBAL_CPPFLAGS += -DUSE_RIL_VERSION_10

# Kernel
BOARD_KERNEL_CMDLINE               := console=none vmalloc=340M androidboot.hardware=qcom user_debug=31 msm_rtb.filter=0x37 ehci-hcd.park=3 androidboot.bootdevice=msm_sdcc.1
...
TARGET_INIT_VENDOR_LIB      := libinit_pa23
TARGET_LIBINIT_DEFINES_FILE := $(LOCAL_PATH)/init/init_pa23.cpp
